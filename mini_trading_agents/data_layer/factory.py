...
def get_data_adapters(provider_keys: dict[str, str]) -> DataAdapters:
    return DataAdapters(
        market=_build_adapter(provider_keys["market"], _MARKET_ADAPTERS, "market"),
...
def _build_adapter(provider_key: str, adapters: dict[str, type], data_kind: str):
    try:
